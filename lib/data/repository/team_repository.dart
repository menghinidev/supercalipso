...
class TeamRepository {
  final ITeamDataSource teamsDataProvider;

  TeamRepository({required this.teamsDataProvider});
  ...
  Future<Response<List<TeamInvitation>>> getUserTeamInvitations({required String userId}) async {
    return await teamsDataProvider.readUserTeamsInvitations(userId: userId);
  }
